...
export function validateTemplateMap(map) {
  ...
  if (map.checklist) {
    if (map.checklist.header_row && typeof map.checklist.header_row !== 'number') {
      errors.push('checklist.header_row debe ser número');
    }
  ...
  if (map.parts) {
    if (map.parts.header_row && typeof map.parts.header_row !== 'number') {
      errors.push('parts.header_row debe ser número');
    }
